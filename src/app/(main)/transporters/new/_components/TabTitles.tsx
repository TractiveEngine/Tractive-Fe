...
export const TabTitles = ({
  ...
  const renderActiveComponent = () => {
    switch (activeTab) {
      ...
      case "On Transit":
        return <OnTransitOrderTracking />;
      case "Delivered":
        return <DeliveredOrderTracking />;
      default:
        return (
          <NewOrderTracking
            isPicked={isPicked}
  ...
  return (
    <div className="w-full flex flex-col gap-4 bg-[#fefefe] p-3 sm:p-4 rounded-[10px]">
      ...
      >
        <div className="flex items-center gap-1 relative" ref={newContainerRef}>
          <button
            role="tab"
            id="new-tab"
