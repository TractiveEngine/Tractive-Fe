  ...
  return (
    <div className="w-full pb-4">
      <div className="w-[90%] mx-auto my-4 grid gap-6 md:grid-cols-1 lg:grid-cols-3">
        {/* Market Access */}
        <div className="flex flex-col justify-center gap-[0.6rem] bg-[#BEDDAE33] rounded-[2px] py-[13px] px-[16px] h-[150px]">
          <div className="flex gap-[8px] items-center">
            ...
            <p className="text-black font-montserrat font-normal text-[13px] md:text-[19px] lg-text-[18px]">
              Market Access
            </p>
          </div>
          <p className="font-montserrat font-normal text-[12px] md:text-[14px] lg:text-[12.5px] text-[#2b2b2b]">
        ...
        <div className="flex flex-col justify-center gap-[0.6rem] bg-[#c5cef233] rounded-[2px] py-[13px] px-[16px] h-[150px]">
          <div className="flex gap-[8px] items-center">
          ...
          <p className="font-montserrat font-normal text-[12px] md:text-[14px] lg:text-[12.5px] text-[#000000]">
        ...
        <div className="flex flex-col justify-center gap-[0.6rem] bg-[#ffe7ac33] rounded-[2px] py-[13px] px-[16px] h-[150px]">
          <div className="flex gap-[8px] items-center">
