...
import { CookiesAgTechLiveChat } from "./CookiesAgTechLiveChat";
import { MobileCookiesAgTechLiveChat } from "./MobileCookiesAgTechLiveChat";
import {  CookiesAgTechLiveChatIpad } from "./CookiesAgTechLiveChatIpad";

interface Props {
  onOpenLiveChat: () => void;
}
export const CookiesHelpCenterHead = ({ onOpenLiveChat }: Props) => {
  return (
    <div className="bg-[#fefefe] w-full">
      <div className="w-[90%] mx-auto py-10 pb-8 flex flex-col gap-[25px] justify-center">
        ...
        <div className="hidden md:hidden lg:block">
          <CookiesAgTechLiveChat onOpen={onOpenLiveChat} />
        </div>
        <div className="hidden md:block lg:hidden">
          <CookiesAgTechLiveChatIpad onOpen={onOpenLiveChat} />
        </div>
        <div className="block md:hidden">
          <MobileCookiesAgTechLiveChat onOpen={onOpenLiveChat} />
        </div>
      </div>
    </div>
  );
