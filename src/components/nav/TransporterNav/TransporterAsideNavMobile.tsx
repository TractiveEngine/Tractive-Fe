  ...
  const navSections: NavSection[] = [
    {
        ...
        items: [
          ...
          { href: "/transporters/negotiations", icon: BidsIcon, label: "Negotiations", hasDot: true },
        ],
      },
      {
        title: "Bookings",
        items: [
          { href: "/transporters/new", icon: Bag2Icon, label: "New", hasDot: true },
          { href: "/transporters/packed", icon: PackedIcon, label: "Packed" },
          { href: "/transporters/on-transit", icon: BoxTickIcon, label: "On Transit" },
          { href: "/transporters/delivered", icon: BoxTickIcon, label: "Delivered" },
        ],
      },
      {
        title: "Transactions",
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/transporters/reviews", icon: MessageStarIcon, label: "Reviews" },
        ],
      },
      {
        title: "Others",
        items: [
          ...
          { href: "/transporters/help", icon: MessageQuestionIcon, label: "Help" },
        ],
      },
  ];
