...
export const CookiesAgTechLiveChat = ({ onOpen }: Props) => {
  return (
      ...
      <div className="flex gap-[140px] w-[100%]">
        <div className="flex flex-col ">
          <div className="flex flex-col items-start justify-start w-[100%] pl-32 py-16">
            ...
            <p className="text-[#f9f9f9] text-left font-montserrat font-normal text-[14.4px] leading-[25px]">
              Connecting farmers, buyers and transporters
            </p>
          </div>
          <div className="flex flex-col items-start justify-start w-[500px] absolute bottom-0 left-0 right-0">
            <Image
