  ...
  return (
    <div className="w-[100%] bg-[#f1f1f1] pt-4">
      <div className="w-[90%] mx-auto bg-[#fefefe] rounded-[10px]">
        ...
        <div className="text-[#2b2b2b] text-[14px] font-montserrat font-normal w-[80%] mx-auto py-10">
          <ol
            role="list"
            className="text-[#2b2b2b] space-y-2 ml-[1.3rem] flex flex-col gap-2 w-[100%] list-decimal"
          >
            <li className="text-[#2b2b2b] font-montserrat text-[10.6px] md:text-[12.6px] font-normal">
