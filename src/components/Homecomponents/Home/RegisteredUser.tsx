...
export const RegisteredUser = () => {
  return (
    <div className="w-full bg-[#538e53] relative z-10">
      <div className="w-[90%] mx-auto py-6 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex gap-6 lg:gap-12">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col justify-center gap-0.5">
              <h1 className="text-[#f9f9f9] text-[1.5rem] md:text-[1.75rem] font-montserrat">
                10,000
              </h1>
              <p className="text-[#f9f9f9] text-[1.1rem] md:text-[1rem] font-montserrat font-normal">
                Farmers
              </p>
            </div>
          </div>
        ...
        <p className="text-[#f9f9f9] font-montserrat font-light text-[1.5rem] sm:text-[2rem] lg:text-[2.5rem] text-center lg:text-right">
