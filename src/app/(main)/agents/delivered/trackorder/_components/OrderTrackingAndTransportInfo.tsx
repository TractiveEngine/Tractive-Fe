...
export const OrderTrackingAndTransportInfo = () => {
  ...
  if (loading) {
    return (
      <div className="w-[100%] flex items-center justify-center mx-auto p-6">
        {/* Loader */}
  ...
  return (
    <div className="w-[65%] h-fit flex flex-col gap-4 bg-[#fefefe] p-4 rounded-[10px] shadow-md">
      ...
      <div className="relative w-[100%]">
        <input
          ...
          className="relative w-full pl-10 py-2 bg-[#f1f1f1] text-[#2b2b2b] rounded-[4px] text-[12px] sm:text-[13px] focus:outline-none sm:h-[40px] focus:ring-[#2B9B1E] placeholder:text-[#2b2b2b] placeholder:text-[13px] sm:placeholder:text-[13px] placeholder:font-montserrat placeholder:font-normal"
      ...
      <div className="flex flex-col gap-4 mt-4">
        <div className="flex flex-col gap-[0.8rem] border-[2px] p-5 rounded-[10px] border-[#538e53] focus:outline-none focus:ring-[#2B9B1E]">
          ...
          {/* Timeline Container */}
          <div className="relative w-[90%] mx-auto h-[40px]">
            {/* Dashed Line: Picked to On Transit */}
            <div className="absolute top-[0.5rem] left-[1rem] right-[11.7rem] h-[2px] border-dashed border-[1px] border-[#808080]"></div>

            {/* Dashed Line: On Transit to Delivered */}
            <div className="absolute top-[0.5rem] left-[11rem] right-[2.5rem] h-[2px] border-dashed border-[1px] border-[#808080]"></div>
