          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#538e53] text-white rounded-md hover:bg-[#467846] font-montserrat text-sm disabled:opacity-50 disable:cursor-not-allowed transition-colors duration-200 cursor-pointer"
              >
                Add
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {formData.categories?.map((category, index) => (
                <span
                  key={index}
                  className="inline-flex items-center gap-2 px-3 py-1 bg-[#538e53] bg-opacity-10 text-[#fefefe] rounded-full text-sm font-montserrat"
                >
                  {category}
                  <button
                  title="Remove category"
                    ...
                    disabled={loading}
                    className="text-[#fefefe] hover:text-red-600 font-bold text-[16px] disabled:opacity-50 cursor-pointer"
                  >
                   x
                  </button>
                </span>
