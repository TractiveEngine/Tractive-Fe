...
import { ParkedProductActionMenu } from "../ActionMenu/ParkedProductActionMenu";
import "../../../Table.css";
import { ParkedProductData, Product } from "@/utils/ProductData";
...
export const PackedProduct: React.FC = () => {
  ...
  const [products, setProducts] = useState<Product[]>(ParkedProductData);
  ...
  const handleDelivered = (id: string) => {
    alert(`Mark product with ID: ${id} as Delivered`);
  };
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesYear =
      !selectedYear || product.date.includes(selectedYear.toString());
    const matchesMonth =
      !selectedMonth ||
    ...
    <div className="w-full mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-[100%] sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] 2xl:w-[50%]">
            <div className="relative w-[100%] sm:w-[70%] flex-grow">
              <input
                ...
                aria-label="Search parked products"
              />
      ...
      <div className="mt-6 w-full">
        <TableList<Product>
          ...
          ActionMenuComponent={ParkedProductActionMenu}
