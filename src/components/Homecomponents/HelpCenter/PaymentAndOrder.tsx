          ...
          <div className="w-full">
            ...
            <div className="text-[#2b2b2b] text-[14px] font-montserrat font-normal">
              <p>
                ...
                approved, you will receive a notification to activate your
                account and gain full access to Agrictech's features. Thank you
                for choosing Agrictech, where we connect farmers, buyers, and a
                thriving agricultural community. Happy farming! The Agrictech
                Team.
              </p>
