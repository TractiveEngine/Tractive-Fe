import { FarmersProps, ApprovalsFarmersProps } from "@/utils/Approvals";
...
const columns: ColumnConfig<FarmersProps>[] = [
  {
    key: "fullname",
    header: "FullName",
  ...
  { key: "onboardedBy", header: "Onboarded By", minWidth: "min-w-[100px]" },
...
export const ApprovalFarmers: React.FC<ApprovalsFarmersProps> = ({
  ...
  // Filter data based on search, year, month, and state
  const filteredFarmers = useMemo(() => {
    return data.filter((farmer) => {
      const matchesYear = selectedYear
        ? farmer.date.includes(selectedYear)
        : true;
      const matchesMonth = selectedMonth
        ? farmer.date.startsWith(
      ...
      const matchesState = selectedState
        ? farmer.location.toLowerCase() === selectedState.toLowerCase()
        : true;
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-[100%] sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] 2xl:w-[50%]">
            ...
            <div className="relative w-[100%] sm:w-[70%] flex-grow">
              <input
                ...
                aria-label="Search all farmers"
                aria-describedby="search-description"
              />
              <span id="search-description" className="sr-only">
                Search for farmers by name or email
              </span>
